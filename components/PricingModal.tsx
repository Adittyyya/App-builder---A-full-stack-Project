...
//                 <div className="mt-auto">
//                   {!isLoaded ? (
//                     // Auth state not resolved yet — show a disabled
//                     // placeholder instead of guessing signed-in/out, so we
//                     // never render a SignInButton for an actually-signed-in
//                     // user (which is what throws the Clerk "already signed
//                     // in" runtime error).
//                     <Button
//                       disabled
//                       className="w-full rounded-full text-sm font-semibold opacity-50"
//                       variant="ghost"
//                     >
//                       Loading…
//                     </Button>
